...
final_court + 
  ...
  ggtitle("Visualizing Shot Selection By Shot Distance (ft)", 
          subtitle = "NBA Regular Seasons 2015-2022") +
  theme_dark() +
  theme(plot.background = element_rect(fill = "papayawhip")) + 
  theme(legend.background = element_rect(fill = "papayawhip"))
```
