...
shots_2022 <- get_shots_data(raw_pbp_data = raw_pbp_2022_data)

##get the shots taken for the 2020-2021 NBA season
shots_2021 <- get_shots_data(raw_pbp_data = raw_pbp_2021_data)

##get the shots taken for the 2019-2020 NBA season
shots_2020 <- get_shots_data(raw_pbp_data = raw_pbp_2020_data)

##get the shots taken for the 2018-2019 NBA season
shots_2019 <- get_shots_data(raw_pbp_data = raw_pbp_2019_data)

##get the shots taken for the 2017-2018 NBA season
shots_2018 <- get_shots_data(raw_pbp_data = raw_pbp_2018_data)

##get the shots taken for the 2016-2017 NBA season
shots_2017 <- get_shots_data(raw_pbp_data = raw_pbp_2017_data)

##get the shots taken for the 2015-2016 NBA season
shots_2016 <- get_shots_data(raw_pbp_data = raw_pbp_2016_data)

##print out a sample of what these data frames look like
head(shots_2017, n=10)
```
