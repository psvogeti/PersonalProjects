...
##responsible for classifying certain stage of the game in period.int format
  ...
  select(GAME_ID, home_team, away_team, stage_of_game, gm_quarter, de, hs, vs, player_shooting, player_team, pts, pt_difference, pt_difference_cat)
