...
##responsible for classifying certain stage of the game in period.int format
  ...
  select(GAME_ID, stage_of_game, de, hs, vs, home_team, away_team, player_shooting, pt_difference)
  
```

```{r PHI-BOS, echo=FALSE}
...
PHI_BOS_breakdown <- sample_game_PHI_BOS %>% 
  ...
  select(stage_of_game, de, hs, vs, home_team, away_team, player_shooting, pt_difference)
```
