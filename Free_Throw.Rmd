...
The output shown above shows $P(F)$ across the models $n$ (`null_model`), $m_p$ (`player_model`), and $m$ (`full_model`).
...
get_ft_prob <- function(player_name, stage_in_game) {
  ...
  null_ft_prob = player_fts %>% pull(null_model) %>% mean()
